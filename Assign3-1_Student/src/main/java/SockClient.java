      ...
      while (requesting) {
        ...
        switch(choice) {
          ...
          case 3:
            ...
            break;
          case 4:
            System.out.println("Choose charcount, enter character to count or hit enter for total charcount:");
            String charInput = scanner.nextLine();
            System.out.println("Enter sample string to be analyzed:");
            ...
            if(charInput.isEmpty()){
              ...
              json.put("find", charInput);
            }
            json.put("count", sample);
            break;
          case 5:
            System.out.println("Choose storyboard, enter sentence to be added to story or press enter to view storyboard:");
        ...
        if (res.getBoolean("ok")) {
          if (res.getString("type").equals("echo")) {
            ...
            JSONArray story = res.getJSONArray("storyboard");
            System.out.println("Storyboard: " + story);
